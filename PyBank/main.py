...
url = "https://raw.githubusercontent.com/the-Coding-Boot-Camp-at-UT/UTAMCB201904DATA3/master/03-Python/Homework/Instructions/PyBank/Resources/budget_data.csv?token=ACC2BRO7ITECZAIEYPSZIQC5AB3WE"
df = pd.read_csv(url)
df.head(10)
